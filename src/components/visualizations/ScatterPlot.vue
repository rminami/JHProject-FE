...
export default {
  ...
  methods: {
     ...
     */
    renderScatterPlot(headers, data) {
      this.width = document.getElementById('scatterplot-wrapper').clientWidth
      this.height = document.getElementById('scatterplot-wrapper').clientHeight
